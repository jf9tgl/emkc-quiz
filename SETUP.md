...
> 💡 **推奨**: タブレットボタンモードが簡単でトラブルも少ないです。
> [タブレットモードのクイックスタート](./docs/QUICK-START-TABLET.md) を参照してください。
...
詳細な手順は [タブレットクイックスタートガイド](./docs/QUICK-START-TABLET.md) を参照してください。
...
4. **タブレット接続**
   - 各タブレットで `http://[サーバーIP]:3000/button` にアクセス

5. **管理画面・表示画面**
   - 管理: `http://localhost:3000/admin`
   - 表示: `http://localhost:3000/display`

詳しくは以下を参照:
- [タブレットシステム設計書](./docs/tablet-system-design.md)
- [タブレット使用ガイド](./docs/TABLET-BUTTON-USAGE.md)
